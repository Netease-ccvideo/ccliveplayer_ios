...
#define FFMPEG_CONFIGURATION "--disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --enable-encoder=aac --enable-encoder=mpeg4 --disable-decoders --enable-decoder=aac --enable-decoder=mpeg4 --enable-decoder=flv --enable-decoder=vp6a --enable-decoder=vp6 --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=gif --enable-decoder=movtext --disable-hwaccels --disable-muxers --enable-muxer=mp4 --disable-demuxers --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegts --enable-demuxer=gif --disable-parsers --enable-parser=aac --enable-parser=h264 --enable-decoder=hevc --enable-bsfs --enable-bsf=mjpeg2jpeg --enable-bsf=mjpeg2jpeg --enable-bsf=mjpega_dump_header --disable-bsf=mov2textsub --disable-bsf=text2movsub --enable-protocols --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol=pipe --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --disable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --disable-devices --disable-filters --disable-iconv --disable-audiotoolbox --disable-videotoolbox --enable-asm --disable-debug --enable-cross-compile --disable-stripping --arch=arm64 --target-os=darwin --enable-static --disable-shared --enable-pic --enable-neon --enable-optimizations --enable-debug --enable-small --prefix=/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/ffmpeg-arm64/output --enable-openssl --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -- xcrun -sdk iphoneos clang' --extra-cflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/openssl-arm64/output/include' --extra-cxxflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/openssl-arm64/output/include' --extra-ldflags=' -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -arch arm64 -miphoneos-version-min=7.0 -fembed-bitcode -I/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/openssl-arm64/output/include -L/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/openssl-arm64/output/lib -lssl -lcrypto'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/cc/.jenkins/workspace/CCFFmpeg-ios/ios/build/ffmpeg-arm64/output/share/ffmpeg"
